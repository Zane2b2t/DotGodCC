...
public class AutoCrystalElite extends Module {
    ...
    public Value<Boolean> renderOnly = (new Value<>("RenderOnly", false, v -> setting.getValue() == Values.RENDER));
    ...
    public String getSuffix() {
        if (!hasPlaced && placedPos != null) {
            return "Placing";
        }
        if (!hasBroken && placedPos != null) {
            return "Breaking";
        }
        return "";
    }
