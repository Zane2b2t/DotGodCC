...
public class hhh extends Module {
    private final Value<Mode> mode = new Value<>("Mode", Mode.ONGROUND);
    private double previousDistance, motionSpeed;
    private int currentState = 1;


    public hhh() {
        super("hhh", Category.MISC);
    }

    private hhh.Mode getMode() {
