...
public class Shader
{
    ...
    public final List<Object> listAuxFramebuffers = Lists.<Object>newArrayList();
    public final List<String> listAuxNames = Lists.<String>newArrayList();
    public final List<Integer> listAuxWidths = Lists.<Integer>newArrayList();
    public final List<Integer> listAuxHeights = Lists.<Integer>newArrayList();
